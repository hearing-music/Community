...
export class ApiService{
	...
	// 酷狗萤火计划 获取标签
	getKugou_yinghuoTag(){
		return this.http.get(this.tencentUrl+"/search?action=kugou_yinghuo_tag")
	}
	// 酷狗 萤火计划
	...
	// 抖音热点
	getDouyinHot(){
		return this.http.get(this.tencentUrl+"/search?action=douyin_hot")
	}
	//抖音短视频
	...
	//铃声多多热铃榜
	lsddHot(){
		return this.http.get(this.tencentUrl+"/search?action=lsdd_hot")
	}
	//铃声多多热铃榜
	lsddSoar(){
		return this.http.get(this.tencentUrl+"/search?action=lsdd_soar")
	}
	//铃声多多古风榜
	lsddArchaic(){
		return this.http.get(this.tencentUrl+"/search?action=lsdd_archaic")
	}
	// 铃声多多搜索
	getLsdd(params:any){
		let {
	...
	//快手热度搜索
	getkuaishouSearch() {
	    return this.http.get(this.tencentUrl+"/search?action=kuaishou_hot")
	}
}