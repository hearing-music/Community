...
export class DouyinVideoComponent implements OnInit {
	...
	douyin_listenDaren() {
		...
		return new Promise((resolve:any)=>{
			this.api.douyin_listenDaren({isVideo:true, nickname,sex, secUid, uniqueId, information,clicklike:obj.totalFavorited,fans:obj.followerCount,
