...
@Component({
	selector: 'ngx-hotSearchListAll',
	templateUrl: './hotSearchListAll.component.html',
	styleUrls: ['./hotSearchListAll.component.scss']
})
export class HotSearchListAllComponent implements OnInit {
	@Input() list: any;
	...
	// 			this.listCount+=item.infoArr.length;
	// 		})
	// 		console.log('初始化')
	// }
	// imgonload(e:any){
